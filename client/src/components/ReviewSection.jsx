      ...
      <div className="flex justify-between items-center">
        ...
        {!showReviewForm && (
          <button
            ...
            className="bg-[#d9a82e] text-white px-4 py-2 rounded-lg hover:bg-[#d9a82e] transition-colors"
          >
            Write a Review
          </button>
        )}
          ...
          <form onSubmit={handleSubmitReview} className="space-y-4">
            ...
            <div className="flex justify-end space-x-3">
              ...
              <button
                ...
                className="px-4 py-2 bg-[#d9a82e] text-white rounded-md hover:bg-[#d9a82e] disabled:opacity-50 disabled:cursor-not-allowed flex items-center space-x-2"
              >
                {submittingReview && (
