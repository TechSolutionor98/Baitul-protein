      ...
      <div className="ml-64 p-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <div className="bg-white rounded-lg shadow-sm p-6 flex flex-col items-center text-center">
            ...
            <p className="text-2xl font-semibold text-gray-900 break-words">{stats.totalOrders}</p>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-sm p-6 flex flex-col items-center text-center">
            ...
            <p className="text-2xl font-semibold text-gray-900 break-words">{formatPrice(stats.totalRevenue)}</p>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-sm p-6 flex flex-col items-center text-center">
            ...
            <p className="text-2xl font-semibold text-gray-900 break-words">{stats.totalProducts}</p>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-sm p-6 flex flex-col items-center text-center">
            ...
            <p className="text-2xl font-semibold text-gray-900 break-words">{stats.totalUsers}</p>
          </div>
        </div>
