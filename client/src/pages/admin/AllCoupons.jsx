    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="ml-64 p-8">
        ...
        <div className="flex gap-3 mb-6">
          <button
            className={`px-4 py-2 rounded-md font-medium border ${filter === "all" ? "bg-[#d9a82e] text-white border-[#d9a82e]" : "bg-white text-gray-700 border-gray-300"}`}
            onClick={() => setFilter("all")}
          >
            All
          </button>
          <button
            className={`px-4 py-2 rounded-md font-medium border ${filter === "active" ? "bg-[#d9a82e] text-white border-[#d9a82e]" : "bg-white text-gray-700 border-gray-300"}`}
            onClick={() => setFilter("active")}
          >
            Active
          </button>
          <button
            className={`px-4 py-2 rounded-md font-medium border ${filter === "expired" ? "bg-[#d9a82e] text-white border-[#d9a82e]" : "bg-white text-gray-700 border-gray-300"}`}
