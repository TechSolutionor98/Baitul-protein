...
//     description: "",
//     iconUrls: [
//       { src: "/baitulProtein/tamara_card.webp", size: "big" },
//     ],
...
//     description: "",
//     iconUrls: [
//       { src: "/baitulProtein/tabby_card.webp", size: "big" },
//     ],
//     color: "", // Remove background color
//   },
//   {
...
//     iconUrls: [
//       {
//         src: "/baitulProtein/master_visa_card.webp",
//         size: "big",
//       },
//     ],
//     color: "", // Remove background color
...
//     name: "",
//     description: "",
//     iconUrls: [{ src: "/baitulProtein/cash.webp", size: "big" }],
//     color: "", // Remove background color
//   },
// ]
...
const STORES = [
  {
    ...
    img: "placeholder.svg?height=200&width=300",
    mapEmbedUrl:
      "https://www.google.com/maps/place/Muwaileh+Commercial+-+Sharjah+-+United+Arab+Emirates/@25.3048327,55.4306383,13.33z/data=!4m6!3m5!1s0x3e5f5f1ab69d4249:0x127fa82fc0a859b4!8m2!3d25.3096921!4d55.4626017!16s%2Fg%2F1tctw0s9?entry=ttu&g_ep=EgoyMDI1MTAyMi4wIKXMDSoASAFQAw%3D%3D",
    coordinates: { lat: 25.2603093, lng: 55.2912192 },
  },
  {
    storeId: "2",
    ...
    img: "/placeholder.svg?height=200&width=300",
    mapEmbedUrl:
      "https://www.google.com/maps/place/Hamidiya+-+Ajman+-+United+Arab+Emirates/@25.3958904,55.5279772,14.71z/data=!4m6!3m5!1s0x3ef5f700d06b7f61:0x3dd77a1d102d0cae!8m2!3d25.39372!4d55.5385871!16s%2Fm%2F03wg5j_?entry=ttu&g_ep=EgoyMDI1MTAyMi4wIKXMDSoASAFQAw%3D%3D",
    coordinates: { lat: 25.2603093, lng: 55.2912192 },
  },
  {
    storeId: "3",
    ...
    img: "/placeholder.svg?height=200&width=300",
    mapEmbedUrl:
      "https://www.google.com/maps/place/Al+Rashidiya+2+-+Ajman+-+United+Arab+Emirates/@25.3965862,55.4292221,15z/data=!3m1!4b1!4m10!1m2!2m1!1sAjman+Rashidiya!3m6!1s0x3e5f5832d4f71ec3:0x479f3b58e443717f!8m2!3d25.3961921!4d55.4457768!15sCg9Bam1hbiBSYXNoaWRpeWGSAQxuZWlnaGJvcmhvb2SqAUcQASoNIglyYXNoaWRpeWEoADIfEAEiGxgO3FCH93zSaNdrTrP6uKaIKMiQASqk69hpbDITEAIiD2FqbWFuIHJhc2hpZGl5YeABAA!16s%2Fg%2F11bbrk2cwq?entry=ttu&g_ep=EgoyMDI1MTAyMi4wIKXMDSoASAFQAw%3D%3D",
    coordinates: { lat: 25.2601835, lng: 55.2915244 },
  },
  // {
  //   storeId: "4",
...
const PAYMENT_METHODS = [
  {
    ...
    description: "",
    iconUrls: [
      { src: "/baitulProtein/TAMARA.webp", size: "big" },
    ],
    color: "", // Remove background color
  },
  {
    ...
    description: "",
    iconUrls: [
      { src: "/baitulProtein/TABBY.webp", size: "big" },
    ],
    color: "", // Remove background color
  },
  {
  ...
  },
  {
    ...
    name: "",
    description: "",
    iconUrls: [{ src: "/baitulProtein/cash_qk1cws (3)3.png", size: "big" }],
    color: "", // Remove background color
  },
]
...
const Checkout = () => {
  ...
  // Ensure we always have a valid Google Maps embed URL for the selected store
  const getMapEmbedUrl = (store) => {
    if (!store) return ""
    const url = (store.mapEmbedUrl || "").trim()
    // If it's already an embed URL, use it as-is
    if (url.includes("/maps/embed?")) return url
    // If it's a short/share/place link, fall back to a query-based embed using the best available string
  ...
  if (cartItems.length === 0) {
    return (
      <div className="max-w-5xl mx-auto px-4 py-10 text-center">
        ...
        <button
          onClick={() => navigate("/")}
          className="text-white rounded-lg px-8 py-3"
          style={{ backgroundColor: "#d9a82e", boxShadow: "0 10px 25px -10px rgba(217,168,46,0.45)" }}
        >
          Continue Shopping
        </button>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5">
          <div className="lg:col-span-3 p-2 ">
            ...
            <div className="flex flex-row items-center gap-2 sm:gap-4 md:gap-8 w-full overflow-x-auto mb-8">
              <div className="flex items-center gap-1 sm:gap-2">
                <span
                  className={`w-8 h-8 flex items-center justify-center rounded-full text-white font-bold ${step >= 1 ? "bg-[#d9a82e]" : "bg-gray-300"}`}
                >
                  01
                </span>
                <span className="font-semibold text-xs sm:text-sm md:text-base">Shipping Details</span>
              ...
              <div className="flex items-center gap-1 sm:gap-2">
                <span
                  className={`w-8 h-8 flex items-center justify-center rounded-full text-white font-bold ${step >= 2 ? "bg-[#d9a82e]" : "bg-gray-300"}`}
                >
                  02
                </span>
                <span
              ...
              <div className="flex items-center gap-1 sm:gap-2">
                <span
                  className={`w-8 h-8 flex items-center justify-center rounded-full text-white font-bold ${step >= 3 ? "bg-[#d9a82e]" : "bg-gray-300"}`}
                >
                  03
                </span>
                <span
                ...
                <>
                  {deliveryType === "home" && (
                    <form onSubmit={handleContinueToSummary}>
                      ...
                      <div className="mt-8 flex gap-4 ">
                        ...
                        <button
                          type="submit"
                          className="flex-1 text-white font-semibold lg:py-3 lg:px-6 py-2 px-3 rounded-lg transition duration-300"
                          style={{ backgroundColor: "#d9a82e", boxShadow: "0 10px 25px -10px rgba(217,168,46,0.45)" }}
                        >
                          <span className="block lg:hidden">Continue Summary</span> {/* Mobile */}
                          <span className="hidden lg:block">Continue to Summary</span> {/* Desktop */}
                  ...
                  {deliveryType === "pickup" && (
                    <form onSubmit={handleContinueToSummary}>
                      ...
                      <div className="mb-6">
                        <h4 className="font-semibold mb-4 flex items-center gap-2">
                          <MapPin className="h-5 w-5" style={{ color: "#d9a82e" }} />
                          Select Store *
                        </h4>
                              ...
                              >
                                <label className="flex items-start gap-3 cursor-pointer">
                                  ...
                                  <div className="flex-1">
                                    <div className="font-semibold text-gray-900">{store.name}</div>
                                    <div className="text-sm text-gray-600 mt-1 leading-relaxed">{store.address}</div>
                                    <div className="text-sm mt-2 font-medium" style={{ color: "#d9a82e" }}>
                                      {store.phone}
                                    </div>
                                  </div>
                                </label>
                      ...
                      <button
                        type="submit"
                        className="text-white rounded-lg px-8 py-3 disabled:opacity-50"
                        style={{ backgroundColor: "#d9a82e", boxShadow: "0 10px 25px -10px rgba(217,168,46,0.45)" }}
                        disabled={!pickupDetails.phone || !pickupDetails.storeId}
                      >
                        Continue
                  ...
                  <div className="mb-6">
                    ...
                    <div className="bg-gray-50 p-4 rounded-lg">
                      ...
                      <textarea
                        value={customerNotes}
                        onChange={(e) => setCustomerNotes(e.target.value)}
                        className="w-full border rounded-lg px-4 py-3 resize-none focus:outline-none focus:ring-2 focus:ring-[#d9a82e] focus:border-transparent"
                        rows="3"
                        placeholder="Special delivery instructions, gift message, or any other notes..."
                        maxLength="500"
                      />
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 gap-2 mb-6">
                    {PAYMENT_METHODS.map((method) => (
                      <div
                        key={method.id}
                        className={` rounded-lg p-4 min-h-32 cursor-pointer transition-all relative ${
                          selectedPaymentMethod === method.id
                            ? "border-[#d9a82e] bg-[#fff7e6]"
                            : "border-gray-200 hover:border-gray-300 bg-white"
                        }`}
                      ...
                      >
                        <label className="flex items-center justify-between w-full cursor-pointer">
                          <div className="flex items-start gap-3">
                            ...
                            <div>
                              ...
                              <div className="text-sm text-gray-500">
                                {method.id === "tamara"
                                  ? "Purchase between AED 100 to AED 2500"
                                  : method.id === "tabby"
                                  ? "Pay by Tabby"
                                  : method.id === "card"
                                  ? "Pay by Card"
                          ...
                          <div className="pl-4">
                            <img
                              src={(method.iconUrls && method.iconUrls[0]?.src) || "/placeholder.svg"}
                              alt={method.name || method.id}
                  ...
                  <div className="flex gap-4">
                    ...
                    <button
                      ...
                      disabled={loading || !selectedPaymentMethod}
                      className="text-white rounded-lg px-6 py-3 disabled:opacity-50 flex items-center gap-2"
                      style={{ backgroundColor: "#d9a82e", boxShadow: "0 10px 25px -10px rgba(217,168,46,0.45)" }}
                    >
                      {loading ? (
                        <>
          ...
          <div className="lg:col-span-2 mt-4">
            <div
              className="rounded-lg shadow-md p-4 lg:mx-9 sticky top-4"
              // style={{ boxShadow: "0 10px 25px -10px rgba(217,168,46,0.45)" }}
            >
              <div className="flex items-center mb-6">
                <div className="p-2 rounded-full" style={{ backgroundColor: "#f8f1df" }}>
                  <Truck className="h-8 w-8" style={{ color: "#d9a82e" }} />
                </div>
                <div className="ml-3">
                  <h2 className="text-lg font-bold text-black">Order Summary</h2>
                  <p className="text-sm text-black">Review your order</p>
              ...
              <div className="mt-6 bg-gray-50 p-4 rounded-lg">
                  <div className="flex items-start">
                  <div className="flex-shrink-0">
                    <Shield className="h-7 w-7" style={{ color: "#d9a82e" }} />
                  </div>
                  <div className="ml-2">
                    <p className="text-xs text-gray-700">
                      Your order is secure and encrypted. We never store your payment information.
