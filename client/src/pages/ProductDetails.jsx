...
const ProductDetails = () => {
  ...
  // Tabs config for Product Description / More Information / Reviews
  const tabKeys = ["description", "information", "reviews"]
...
// CHANGE: replace frequently-bought logic with category-specific accessory mapping
  ...
  if (loading) {
    // Neutral skeleton while the product details load (no icon)
    return (
      <div className="bg-white min-h-[60vh]">
        <div className="max-w-8xl mx-auto px-4 py-6">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 animate-pulse">
            ...
            {/* Middle: title/pricing text blocks */}
            ...
            <div className="bg-white rounded-lg p-2">
              ...
              <div className="space-y-4 mb-6">
                <div className="flex items-center space-x-2 ">
                  <div className="flex items-center border-2 border-black  rounded-lg bg-[#2377c1]">
                    <button
                      onClick={() => handleQuantityChange(-1)}
                      className="px-3 py-2 text-white transition-colors bg-[#2377c1]"
                      disabled={quantity <= 1}
                    >
                      <Minus size={16} />
                    </button>
                    <span className="px-4 py-2 border-l border-r border-black min-w-[60px] text-center font-medium text-white">
                      {quantity}
                    </span>
                    <button
                      onClick={() => handleQuantityChange(1)}
                  ...
                  <div className="flex items-center  w-full ">
                    <button
                      ...
                      className=" bg-[#d9a82e] hover:bg-[#d9a82e] disabled:bg-gray-400 text-white py-3 px-9 rounded-lg font-medium transition-colors"
                    >
                    ...
                    <button
                      disabled={product.stockStatus === "Out of Stock"}
                      className="hidden sm:block w-full ml-1 bg-\[#d4af37\] hover:bg-\[#c19a2f\] disabled:bg-gray-400 text-white px-3 py-3 rounded-lg font-medium transition-colors"
                ...
                <button
                  disabled={product.stockStatus === "Out of Stock"}
                  className=" md:hidden lg:hidden w-full ml-1 bg-\[#d4af37\] hover:bg-\[#c19a2f\] disabled:bg-gray-400 text-white px-3 py-3 rounded-lg font-medium transition-colors"
                  onClick={handleBuyNow}
                >
                  Buy Now
                </button>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 py-4 text-center">
                {/* WhatsApp Chat */}
                <div className="border-2 border-[#d9a82e] rounded-lg p-2 transition-transform duration-200 hover:scale-105 hover:shadow-md group overflow-hidden bg-white">
                  <button
                    className="flex flex-col items-center w-full bg-[#d9a82e] text-black rounded-md py-3 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#d9a82e] hover:brightness-95"
                    onClick={() =>
                      window.open(
                  ...
                  >
                    <MessageCircle
                      size={24}
                      className="mb-2 text-black transform transition-transform duration-300 group-hover:-translate-y-1"
                    />
                ...
                <div className="border-2 border-[#d9a82e] rounded-lg p-2 transition-transform duration-200 hover:scale-105 hover:shadow-md group overflow-hidden bg-white">
                  ...
                  >
                    <Phone
                      ...
                      className="mb-2 text-black transform transition-transform duration-300 group-hover:-translate-y-1"
                    />
                    <span className="text-xs text-black font-semibold">Request a Callback</span>
                  </button>
                </div>
                ...
                <div className="border-2 border-[#d9a82e] rounded-lg p-2 transition-transform duration-200 hover:scale-105 hover:shadow-md group overflow-hidden bg-white">
                  <button
                    type="button"
                    className="flex flex-col items-center w-full focus:outline-none group bg-[#d9a82e] text-black rounded-md py-3 focus:ring-2 focus:ring-offset-2 focus:ring-[#d9a82e] hover:brightness-95"
                    onClick={() => navigate("/bulk-purchase")}
                  >
                    <Shield
                      className="mx-auto mb-2 text-black transform transition-transform duration-300 group-hover:-translate-y-1"
                      size={24}
                    />
          ...
          <div className="lg:col-span-3">
            <div className="bg-white rounded-lg p-3 space-y-6">
              ...
              <div className="bg-yellow-50 rounded-lg p-4">
                ...
                <button
                  className="w-full bg-[#d9a82e] text-black py-2 px-4 rounded font-bold text-sm hover:bg-[#d9a82e] transition-colors"
              ...
              <div className="border-t pt-4">
                <h4 className="font-bold text-white p-2 rounded-lg bg-[#2377c1] text-center text-md mb-3">
                  Payment Methods :{" "}
                </h4>
...
<div className="bg-white rounded-2xl shadow-sm mt-10 border border-gray-100">
  {/* Top tab header removed per request. Buttons moved to right sidebar. */}

  <div className="p-5 sm:p-6">
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
      {/* Main content - full height, no internal scroll */}
      <div className="lg:col-span-8 pr-1">
        {activeTab === "description" && (
          <div>
        ...
        {activeTab === "information" && (
          <div>
            <h3 className="text-xl font-bold mb-3 text-gray-900">More Information</h3>
            <div className="overflow-x-auto rounded-xl border border-gray-100">
              <table className="w-full border-collapse text-sm">
                <tbody>
                  <tr className="bg-gray-50/60">
                    <td className="border border-gray-100 px-4 py-3 font-medium text-gray-900 w-1/4">Brand</td>
                    <td className="border border-gray-100 px-4 py-3 text-gray-700">
                      {product.brand?.name || product.brand || "N/A"}
                    </td>
                  </tr>
                  <tr className="bg-white">
                    <td className="border border-gray-100 px-4 py-3 font-medium text-gray-900 w-1/4">
                      Model Number
                    </td>
                    <td className="border border-gray-100 px-4 py-3 text-gray-700">{product.sku || "N/A"}</td>
                  </tr>
                  <tr className="bg-white">
                    <td className="border border-gray-100 px-4 py-3 font-medium text-gray-900 w-1/4">Category</td>
                    <td className="border border-gray-100 px-4 py-3 text-gray-700">
                      {product.category?.name || product.category || "N/A"}
                    </td>
                  </tr>
                  {product.warranty && (
                    <tr className="bg-white">
                      <td className="border border-gray-100 px-4 py-3 font-medium text-gray-900 w-1/4">Warranty</td>
                      <td className="border border-gray-100 px-4 py-3 text-gray-700">{product.warranty}</td>
                    </tr>
                  )}
                  ...
                  {product.specifications &&
                    product.specifications.length > 0 &&
                    product.specifications.map((spec, index) => (
                      <tr key={index} className={index % 2 === 0 ? "bg-gray-50/60" : "bg-white"}>
                        <td className="border border-gray-100 px-4 py-3 font-medium text-gray-900 w-1/4">
                          {spec.key}
                        </td>
                        <td className="border border-gray-100 px-4 py-3 text-gray-700">{spec.value}</td>
                      </tr>
                    ))}
                </tbody>
              </table>
      ...
      {/* Right sidebar - Replaced Quick Specs with fixed tab buttons */}
  <aside className="lg:col-span-4 space-y-4 h-full">
  <div className="rounded-xl border border-gray-100 bg-gray-50 p-4 sticky top-24 lg:top-36">
            ...
            <button
              ...
              className={`w-full py-2.5 rounded-lg text-sm font-semibold transition-colors ${
                activeTab === "description"
                  ...
                  : "bg-[#2377c1] text-white hover:bg-[#1f69a8]"
              }`}
            >
              Product Description
            </button>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-4">
              {shuffleArray(relatedProducts)
                ...
                .map((p) => {
                  ...
                  const rating = Number(p?.averageRating ?? p?.rating ?? 0) || 0
                  const reviewCount = Number(p?.reviewCount ?? p?.numReviews ?? 0) || 0
                  ...
                  return (
                    <article key={p._id} className="group text-center bg-white rounded-lg shadow-sm p-4 border hover:shadow-md transition-shadow">
                      <Link to={`/product/${p.slug || p._id}`} className="block">
                        <div className="relative flex items-center justify-center bg-white">
                          <div className="aspect-[4/3] w-full max-w-[260px] mx-auto flex items-center justify-center">
                            <img
                              src={p.image || "/placeholder.svg?height=128&width=128"}
                              alt={p.name}
                              className="w-full h-full object-contain"
                              loading="lazy"
                            />
                      ...
                      {/* Stars above name */}
                      <div className="mt-2 px-6 flex items-center justify-center gap-1">
                        {Array.from({ length: 5 }).map((_, i) => (
                      ...
                      <div className="mt-2 text-sm font-semibold text-black leading-snug line-clamp-2 min-h-[40px] px-6">
                        {p.name}
                      </div>

                      {/* Price row */}
                      <div className="mt-1 text-[13px] flex items-center justify-center gap-2">
                        <span className="text-red-600 font-semibold">{formatPrice(hasDiscount ? offer : price)}</span>
                        {hasDiscount && (
                          <span className="text-gray-500 line-through decoration-gray-400">{formatPrice(price)}</span>
                        )}
                      </div>
                      ...
                      <div className="mt-3">
                        <Link
                          ...
                          className="inline-flex items-center justify-center rounded-full bg-[#d4af37] text-black px-6 py-2 text-sm font-semibold shadow-sm hover:brightness-95 transition"
                        >
                          Choose options
                        </Link>
                      </div>
      ...
      {showCallbackModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
          <div className="bg-white rounded-xl p-5 w-full max-w-sm sm:max-w-sm md:max-w-sm lg:max-w-md shadow-xl relative border border-[#d9a82e]">
            <button
              className="absolute top-2 right-2 text-gray-400 hover:text-gray-600 focus:outline-none focus:ring-2 focus:ring-[#d9a82e] focus:ring-offset-2 rounded-full"
            ...
            <div className="flex flex-col md:flex-row items-center gap-6 md:gap-10">
              <div className="flex-1 w-full">
                <h2 className="text-xl text-center font-bold mb-1">Request a Callback</h2>
                <div className="h-1 w-16 bg-[#d9a82e] mx-auto rounded mb-4" />
                {callbackSuccess ? (
                  <div className="text-center font-medium text-[#d9a82e]">Request submitted successfully!</div>
                ) : (
                  <form onSubmit={handleCallbackSubmit} className="space-y-5">
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <input
                          ...
                          className="flex-1 py-2 px-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#d9a82e] focus:border-[#d9a82e]"
                          required
                        />
                      </div>
                    </div>
                    ...
                    <button
                      type="submit"
                      className="w-full bg-[#d9a82e] text-black py-2 rounded-md font-semibold hover:brightness-95 focus:outline-none focus:ring-2 focus:ring-[#d9a82e] focus:ring-offset-2"
